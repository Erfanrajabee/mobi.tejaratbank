(window.webpackJsonp = window.webpackJsonp || []).push([[30], {
	...
	881: function(e, a, t) {
		...
		var O = function(e) {
			...
			, []);
			const A = _.visible_comments ? " " : "isView"
			  , k = _.visible_deposit_id ? " " : "isView";
			Object(n.useEffect)( () => {
				t.state && (t.state.amount && "/account/requestMoney" != t.state.backUrl && I(t.state.amount, 10000),
				t.state.amount && "/account/requestMoney" === t.state.backUrl && I(t.state.amount.amount, 10000))
			}
			, [t.state]);
			let S = c.map(e => {
